...
export default function page() {
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
        ...
        <p>
            <b>Our Mission: Bringing the Magic of Cinema to Your Fingertips</b>
            <p>
            Our mission at IMDb Clone is simple yet profound: to connect people with the stories that captivate, inspire, and entertain. We believe in the power of storytelling to transcend boundaries and create shared experiences. By providing a vast and meticulously curated database of films, TV shows, and beyond, we aim to empower users to discover, explore, and engage with the rich tapestry of content that the world of entertainment has to offer.
            </p>
        </p>
        <p>
